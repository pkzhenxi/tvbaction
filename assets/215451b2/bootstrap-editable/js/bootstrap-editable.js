    ...
    $.fn.editableform.defaults = {
        ...
        **/
        ...
        url: function(params) {
            var d = new $.Deferred;
            if(params.value === 'abc') {
                return d.reject('error messages'); //returning error via deferred object
            } else {
        ...
        **/         
        ...
        If it returns **string** - means error occured and string is shown as error messages.
        ...
        **/          
        ...
        Usefull when you want to parse error response and display a custom messages.
        Must return **string** - the messages to be displayed in the error block.
    ...
    AbstractInput.prototype = {
       ...
       */
       prerender: function() {
           ...
           this.error = null;               //error messages, if input cannot be rendered
       },
...
(function ($) {
    ...
    List.defaults = $.extend({}, $.fn.editabletypes.abstractinput.defaults, {
        ...
        **/         
        prepend: false,
        /**
        Error messages when list cannot be loaded (e.g. ajax error)
