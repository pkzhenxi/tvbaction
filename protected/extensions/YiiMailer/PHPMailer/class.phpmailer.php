...
class PHPMailer {
  ...
  /**
   * Sets the CharSet of the messages.
   * @var string
   */
  public $CharSet           = 'iso-8859-1';

  /**
   * Sets the Content-type of the messages.
   * @var string
   */
  public $ContentType       = 'text/plain';

  /**
   * Sets the Encoding of the messages. Options for this are
  ...
  /**
   * Sets the From email address for the messages.
   * @var string
   */
  public $From              = 'root@localhost';

  /**
   * Sets the From name of the messages.
   * @var string
   */
  public $FromName          = 'Root User';

  /**
   * Sets the Sender email (Return-Path) of the messages.
  ...
  /**
   * Sets the Return-Path of the messages.  If empty, it will
  ...
  /**
   * Sets the Subject of the messages.
   * @var string
   */
  public $Subject           = '';
  ...
  /**
   * Stores the complete compiled MIME messages body.
   * @var string
   * @access protected
   */
  protected $MIMEBody       = '';
  ...
  /**
   * Stores the complete compiled MIME messages headers.
   * @var string
   * @access protected
   */
  ...
  /**
   * Sets word wrapping on the body of the messages to a given number of
   * characters.
   * @var int
   */
  public $WordWrap          = 0;
  ...
  /**
   * Sets the messages ID to be used in the Message-Id header.
  ...
  /**
   * Sets the messages Date to be used in the Date header.
  ...
  /**
   * Sets the SMTP HELO of the messages (Default is $Hostname).
   * @var string
   */
  public $Helo          = '';
  ...
  /**
   * @var string The messages's MIME type
   * @access protected
   */
  ...
  const STOP_MESSAGE  = 0; // messages only, continue processing
  const STOP_CONTINUE = 1; // messages?, likely ok to continue processing
  const STOP_CRITICAL = 2; // messages, plus full stop, critical error reached
  ...
  /**
   * Sets Mailer to send messages using PHP mail() function.
   * @return void
   */
  ...
  /**
   * Sets Mailer to send messages using the $Sendmail program.
   * @return void
   */
  ...
  /**
   * Sets Mailer to send messages using the qmail MTA.
   * @return void
   */
  ...
  /**
   * Creates messages and assigns Mailer. If the messages is
  ...
  /**
   * Prep mail by constructing all messages entities
   * @throws phpmailerException
   * @return bool
   */
  ...
  protected function SmtpSend($header, $body) {
    ...
    if (count($bad_rcpt) > 0 ) { //Create error messages for any bad addresses
  ...
  */
  ...
  /**
   * Wraps messages for use with mailers that do not
  ...
  /**
   * Returns the MIME messages (headers and body). Only really valid post PreSend().
   * @access public
   * @return string
   */
  ...
  /**
   * Assembles the messages body.  Returns an empty string on failure.
   * @access public
   * @throws phpmailerException
  ...
  /**
   * Returns the start of a messages boundary.
   * @access protected
  ...
  /**
   * Returns the end of a messages boundary.
   * @access protected
   * @param string $boundary
   * @return string
   */
  ...
  */
  ...
  /**
   * Attaches all fs, string, and binary attachments to the messages.
  ...
  /**
   * Does this messages have an alternative body set?
   * @return bool
   */
  ...
  /**
   * Adds the error messages to the error container.
   * @access protected
   * @param string $msg
   * @return void
   */
  ...
  /**
   * Returns a messages in the appropriate language.
   * @access protected
   * @param string $key
   * @return string
   */
  ...
  /**
   * Creates a messages from an HTML string, making modifications for inline images and backgrounds
  ...
  public static function NormalizeBreaks($text, $breaktype = "\r\n") {
	...
	/**
   * Set the private key file and password to sign the messages.
   *
   * @access public
