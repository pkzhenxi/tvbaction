...
class YiiMailer extends PHPMailer {
	...
	/**
	 * Sets the text-only body of the messages.
	 * @var string
	 */
	public $AltBody='';
	...
	/**
	 * Render HTML email messages with layout
	 * @param string $message Email messages
	 * @param string $basedir Path for images to embed in messages
	 */
	...
	/**
	 * Render messages and send emails
	...
	public function send()
	{
		...
		try{
			...
			//in test mode, save messages as a file
			if($this->testMode)
				return $this->save();
			else
